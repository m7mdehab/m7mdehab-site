    ...
    <main className="proto-page kinetic" id="main-content">
      ...
      <section className="kinetic-hero proto-shell">
        <div className="kinetic-title">
          ...
          <div className="proto-actions"><a className="proto-button" href="#work">Selected work ↘</a><a className="proto-button" href={`mailto:${profile.email}`}>Discuss an opportunity ↗</a></div>
        </div>
      ...
      <section className="kinetic-cta proto-shell" id="contact"><div><p className="proto-eyebrow">Opportunity · 03</p><h2>Role, project or system problem <span className="proto-serif">worth discussing?</span></h2></div><div className="proto-actions"><a className="proto-button" href={`mailto:${profile.email}`}>Email ↗</a><a className="proto-button" href={profile.linkedin}>LinkedIn ↗</a></div></section>
    </main>
  );
}
